...
/***********************************************************************
  function name: SetTVMode(BOOL bPAL, BOOL bSVideo, BOOL bPAL625, BOOL bMaster)
...
void SetTVMode(BYTE BarMode, BOOL bPAL, BOOL bSVideo, BOOL bPAL625, BOOL bMaster)
{
	...
	tmp = ((BarMode&0x3)<<4) | (bPAL<<3) | (bSVideo<<2) | (bPAL625<<1) | bMaster;
...
//	SetDecode(CONTINUE_FRAME_IP);
	...
	SetTVMode(0/*BarMode*/, TRUE/*bPAL*/, FALSE/*bSVideo*/, TRUE/*bPAL625*/, TRUE/*bMaster*/);
	SetDisplayFrameBase(D);
