...
extern void irqhandler(int irq);
extern void force_irq (int irq);
extern void disable_irq (int irq);
extern void enable_irq (int irq);
extern void level_irq (int irq, int level) ;
...
#define BPROM		0x00000000
#define PROM		0x10000000
#define IOAREA	0x20000000
#define CRAM		0x40000000
#define ITCM		0x40000000
#define DTCM		0x50000000
...
#define IRQ_TIMER2	9
#define IRQ_2ND			10
#define IRQ_DSUTRACE	11
#define IRQ_USER1	12
#define IRQ_USER2	13
#define IRQ_USER3	14
#define IRQ_USER4	15
#define IRQ_PCI		IRQ_USER3
