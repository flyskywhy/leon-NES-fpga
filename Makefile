LeonDir = ..\..\Project\Reuse\Leon\software
vpath %.c gamefile
########################### Common Part ##############################
...
include ${LeonDir}/script/LeonMake.mak
...
#--------- C Runtime Lib -----------
# 若无需加入CRT，则将以下变量设为空
#CrtLinkFlags		= -L/opt/sparc-elf/lib/gcc-lib/sparc-elf/3.2.3
#CrtLinkLibs			= -lc -lgcc -lsyscalls -lleon
