...
{                                  
    rSYSCFG = CACHECFG;
    //8K◊÷Ω⁄cache£¨–¥ª∫≥Â πƒ‹£¨data abort πƒ‹

	rNCACHBE0 = ((Non_Cache_End>>12)<<16)|(Non_Cache_Start>>12);
    //‘⁄…œ√Êµƒ ˝æ›«¯”Ú≤ª π”√∏ﬂÀŸª∫¥Ê

    Port_Init();
    rADCCON = 0x14;
    rADCPSR = 0xf0;

	//ChangePllValue( 56, 2, 1 );		//æß’Ò8MHz£¨–ﬁ∏ƒœµÕ≥÷˜∆µŒ™8±∂∆µ(64MHz)
	//ChangePllValue( 56, 3, 1 );		//æß’Ò10MHz£¨–ﬁ∏ƒœµÕ≥÷˜∆µŒ™6.4±∂∆µ(64MHz)
	ChangePllValue( 24, 3, 1 );		//æß’Ò10MHz£¨–ﬁ∏ƒœµÕ≥÷˜∆µŒ™3.2±∂∆µ(32MHz)
    
//lizheng     Led_Display(0x00);
//lizheng     Delay(500);
//lizheng     Led_Display(0x07);
//lizheng     Delay(500);
//lizheng     Led_Display(0x0);
//lizheng    
/*    Uart_Init(0,57600);
