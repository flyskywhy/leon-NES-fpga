...
//减容 #define Map5_ROMPAGE(a)     &Map5_Wram[ ( (a) & 0x07 ) * 0x2000 ]
/* The address of 1Kbytes unit of the Map6 Chr RAM */
//减容 #define Map6_VROMPAGE(a)    &Map6_Chr_Ram[ (a) * 0x400 ]
/* The address of 1Kbytes unit of the Map19 Chr RAM */
//减容 #define Map19_VROMPAGE(a)   &Map19_Chr_Ram[ (a) * 0x400 ]
/* The address of 1Kbytes unit of the Map85 Chr RAM */
//减容 #define Map85_VROMPAGE(a)   &Map85_Chr_Ram[ (a) * 0x400 ]
...
BYTE Map255_ReadApu( WORD wAddr );*///减容
